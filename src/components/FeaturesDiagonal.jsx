...
import featuresdiagonal from "../assets/images/blueprint-370588_1280.jpg";
...
export const FeaturesDiagonal = () => {
  ...
  return (
    <section className="lg:mb-16 w-full flex flex-col justify-center items-center bg-customDarkBg1">
        ...
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            ...
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl custom-block-big-title">
              Plan &amp; Build without problems
            </h2>
            <p className="mb-16 text-customGrayText leading-loose">
              We enable you to launch your projects with
              ease. 
            </p>
            <div
      ...
      {isModalOpen && (
        <InvitationModal className="absolute" isOpen={isModalOpen} setIsOpen={setIsModalOpen} />
      )}
    </section>
  );
};
