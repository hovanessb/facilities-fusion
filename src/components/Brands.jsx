      ...
      <div className="container px-4 mx-auto 2xl:w-[1200px] xl:w-[1100px] lg:w-[1000px] md:w-4/5">
        <div className="flex lg:flex-row flex-col items-center -mx-4 justify-center lg:text-left text-center">
          ...
          <div className="w-2/3 sm:w-[620px] lg:w-1/2 mx-auto lg:mx-0 lg:pl-10">
            <div className="flex flex-wrap text-customGrayText -m-4">
              <p>At Facilities Fusion, we take pride in our partnerships with leading brands in the industry. Our commitment to quality and excellence is reflected in the brands we choose to collaborate with. These partnerships allow us to provide top-tier products and services to our clients, ensuring that their facilities are always in the best possible condition.</p>
            </div>
          </div>
        </div>
      </div>
